...
export const ARGENTINE_FOOD_DATABASE: ArgentineFood[] = [
  ...
  {
    id: 'arg_galletitas_chocolinas',
    name: 'Galletitas Chocolinas de chocolate',
    category: 'Panificados y Dulces',
    tags: ['galletitas', 'galletita', 'chocolinas', 'chocotorta', 'chocolate', 'paquete', 'snack', 'merienda'],
    unitName: 'galletita (unidad)',
    gramsPerUnit: 6.25,
    per100g: { calories: 432, protein: 7.0, carbs: 70.0, fat: 13.0 },
    defaultUnitCount: 4,
    popular: true,
  },
  {
    id: 'arg_galletitas_oreo',
    name: 'Galletitas Oreo rellenas de crema',
    category: 'Panificados y Dulces',
    tags: ['galletitas', 'galletita', 'oreo', 'chocolate', 'rellenas', 'paquete', 'snack', 'merienda'],
    unitName: 'galletita rellena (unidad)',
    gramsPerUnit: 11,
    per100g: { calories: 478, protein: 5.2, carbs: 68.5, fat: 20.0 },
    defaultUnitCount: 4,
    popular: true,
  },
  {
    id: 'arg_galletitas_criollitas',
    name: 'Galletitas de agua Criollitas / Express',
    category: 'Panificados y Dulces',
    tags: ['galletitas', 'galletita', 'agua', 'criollitas', 'express', 'traviata', 'paquete', 'desayuno'],
    unitName: 'galletita de agua (unidad)',
    gramsPerUnit: 6,
    per100g: { calories: 415, protein: 10.0, carbs: 70.0, fat: 10.0 },
    defaultUnitCount: 4,
    popular: true,
  },
  {
    id: 'arg_galletitas_cerealitas',
    name: 'Galletitas Cerealitas / salvado y granos',
    category: 'Panificados y Dulces',
    tags: ['galletitas', 'galletita', 'cerealitas', 'salvado', 'granos', 'fibra', 'paquete'],
    unitName: 'galletita (unidad)',
    gramsPerUnit: 8.5,
    per100g: { calories: 438, protein: 9.5, carbs: 66.0, fat: 14.5 },
    defaultUnitCount: 4,
    popular: true,
  },
  {
  ...
  {
    id: 'arg_frutillas',
    name: 'Frutillas frescas / Fresas',
    category: 'Frutas',
    tags: ['frutilla', 'frutillas', 'fresa', 'fresas', 'fruta', 'frutos rojos', 'postre', 'antioxidante', 'bajas calorias', 'vitamina c'],
    unitName: 'taza de frutillas (150g)',
    gramsPerUnit: 150,
  ...
  },
  {
    ...
    category: 'Frutas',
    tags: ['arandano', 'arandanos', 'arándanos', 'blueberries', 'fruta', 'frutos rojos', 'antioxidante'],
    unitName: 'pocillo / taza (100g)',
    gramsPerUnit: 100,
  ...
  {
    id: 'arg_naranja',
    name: 'Naranja fresca (de ombligo / jugo)',
    category: 'Frutas',
    tags: ['naranja', 'citrico', 'fruta', 'vitamina c', 'jugo'],
    unitName: 'naranja mediana pelada',
    gramsPerUnit: 150,
  ...
  {
    id: 'arg_mandarina',
    name: 'Mandarina fresca criolla',
    category: 'Frutas',
    tags: ['mandarina', 'citrico', 'fruta', 'merienda', 'vitamina c'],
    unitName: 'mandarina mediana',
    gramsPerUnit: 100,
  ...
  {
    id: 'arg_pera',
    name: 'Pera Williams / de agua',
    category: 'Frutas',
    tags: ['pera', 'fruta', 'fibra', 'jugosa'],
    unitName: 'pera mediana',
    gramsPerUnit: 160,
  ...
  {
    id: 'arg_durazno',
    name: 'Durazno fresco / Melocotón',
    category: 'Frutas',
    tags: ['durazno', 'melocoton', 'fruta', 'verano'],
    unitName: 'durazno mediano',
    gramsPerUnit: 150,
  ...
  {
    id: 'arg_kiwi',
    name: 'Kiwi verde / amarillo',
    category: 'Frutas',
    tags: ['kiwi', 'fruta', 'vitamina c', 'digestion'],
    unitName: 'kiwi mediano pelado',
    gramsPerUnit: 80,
  ...
  },
  {
    ...
    name: 'Sandía fresca',
    category: 'Frutas',
    tags: ['sandia', 'fruta', 'hidratacion', 'verano', 'bajas calorias'],
    unitName: 'tajada o rodaja (250g)',
    gramsPerUnit: 250,
  ...
  {
    id: 'arg_melon',
    name: 'Melón fresco (rocío de miel / escrito)',
    category: 'Frutas',
    tags: ['melon', 'fruta', 'dulce', 'hidratacion'],
    unitName: 'tajada mediana limpia (200g)',
    gramsPerUnit: 200,
  ...
  {
    id: 'arg_uvas',
    name: 'Uvas frescas (blancas o tintas)',
    category: 'Frutas',
    tags: ['uva', 'uvas', 'fruta', 'racimo', 'dulce'],
    unitName: 'racimo chico (100g)',
    gramsPerUnit: 100,
  ...
  {
    id: 'arg_anana',
    name: 'Ananá fresco / Piña',
    category: 'Frutas',
    tags: ['anana', 'ananá', 'piña', 'fruta', 'bromelina', 'digestivo'],
    unitName: 'rodaja gruesa limpia (120g)',
    gramsPerUnit: 120,
  ...
  {
    id: 'arg_frutos_rojos_mix',
    name: 'Mix de Frutos Rojos (frutilla, frambuesa, arándano, mora)',
    category: 'Frutas',
    tags: ['frutos rojos', 'frutilla', 'frambuesa', 'mora', 'arandano', 'berries', 'smoothie'],
    unitName: 'taza (120g)',
    gramsPerUnit: 120,
    per100g: { calories: 42, protein: 0.9, carbs: 9.8, fat: 0.4 },
    defaultUnitCount: 1,
    popular: true,
  },
  {
